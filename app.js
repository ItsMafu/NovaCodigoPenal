...
function updateCalc(){const m=+$('#calcMonths').value||0;const l=level(m);$('#level').textContent=l.toUpperCase();$('#levelText').textContent=l==='grave'?'Sanción de alta duración.':l==='media'?'Sanción de duración intermedia.':'Sanción de baja duración.'}
